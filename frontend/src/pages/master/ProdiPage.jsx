...
export const ProdiPage = () => {
  const mutations = useResourceMutations("prodi", {
    remove: "Program studi berhasil dihapus.",
  });
  ...
  const columns = [
    { key: "kode_prodi", header: "Kode Prodi", sortable: true },
    {
      ...
      sortable: true,
      render: (row) =>
        row.jenjangAkademik?.nama_jenjang ||
        row.jenjangAkademik?.kode_jenjang ||
        "—",
    },
    {
      key: "fakultas_id",
