...
export const MatakuliahPage = () => {
  ...
  return (
    <MasterListPage
      ...
      breadcrumbs={[{ label: "Kurikulum & MK" }, { label: "Mata Kuliah" }]}
      subject="Matakuliah"
      resource="matakuliah"
      idKey="id"
      ...
      columns={[
        ...
        { key: "semester_kurikulum", header: "Semester", sortable: true },
        {
          ...
          render: (row) =>
            row.has_prasyarat ? (
              <span className="badge badge-warning badge-sm">Ada</span>
            ) : (
      ...
      detailItems={(row) => [
        ...
        {
          label: "Punya Prasyarat",
          value: row.has_prasyarat ? "Ya (tidak bisa lintas prodi)" : "Tidak",
        },
      ]}
    />
  );
