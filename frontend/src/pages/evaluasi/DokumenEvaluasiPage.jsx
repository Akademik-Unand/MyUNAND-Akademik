...
export const DokumenEvaluasiPage = () => {
  ...
  const mutations = useResourceMutations("dokumen-evaluasi", {
    create: "Dokumen berhasil disimpan.",
  });
    ...
    >
      <Card>
        <div className="tabs tabs-box mb-4 w-fit bg-base-200">
          <button
            type="button"
            className={`tab ${tab === "daftar" ? "tab-active" : ""}`}
          ...
          <button
            type="button"
            className={`tab ${tab === "jenis" ? "tab-active" : ""}`}
      ...
      <Modal
        ...
        footer={
          <FormActions
            ...
            onSubmitClick={() =>
              document.getElementById("upload-dokumen-form")?.requestSubmit()
            }
          />
        }
      >
        <form
          id="upload-dokumen-form"
          className="space-y-3"
        ...
        >
          ...
          <ResourceSelect
            ...
            onChange={(e) =>
              setForm((prev) => ({
                ...prev,
                jenis_dokumen_evaluasi_id: e.target.value,
              }))
            }
          ...
          <Input
            ...
            onChange={(e) =>
              setForm((prev) => ({ ...prev, file_path: e.target.value }))
            }
          />
        </form>
      </Modal>
