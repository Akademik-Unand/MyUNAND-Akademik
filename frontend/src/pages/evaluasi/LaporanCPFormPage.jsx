      ...
      <Card title="Data Laporan">
        ...
        >
          <Input
            ...
            onChange={(e) =>
              setValues({ ...values, nama_laporan: e.target.value })
            }
            required
          />
          <Textarea
          ...
          <ResourceSelect
            ...
            onChange={(e) =>
              setValues({ ...values, semester_id: e.target.value })
            }
      ...
      <Card title="Pilih mata kuliah yang memenuhi CP/SCP">
        {!values.kurikulum_id ? (
          <p className="text-sm text-base-content/60">
            Pilih kurikulum untuk menampilkan pemetaan CP, SCP, CPMK, dan mata
            kuliah.
          </p>
        ) : preview.isPending ? (
          ...
          <p className="text-sm text-error">
            {preview.error?.message || "Gagal memuat pratinjau."}
          </p>
        ) : (
          <LaporanCpPickTable
            rows={rows}
