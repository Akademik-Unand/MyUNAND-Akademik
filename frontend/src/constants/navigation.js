 ...
 * Menu dikelompokkan & diurutkan mengikuti alur proses akademik:
 * Master Data (referensi) → Kurikulum & MK (desain) → Perkuliahan (eksekusi) → KRS Mahasiswa.
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: "CalendarClock",
        permission: { action: "read", subject: "JadwalKelas" },
      },
      {
        label: "Shift Jadwal",
        path: "/perkuliahan/shift",
        icon: "Clock",
        permission: { action: "read", subject: "Shift" },
      },
      {
        label: "Upload Nilai",
      ...
      },
      {
        ...
        icon: "ClipboardCheck",
        permission: { action: "approve", subject: "Krs" },
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        icon: "UsersRound",
        permission: { action: "read", subject: "BimbinganAkademik" },
      },
      {
        // Penetapan PA adalah kewenangan admin unit; dosen/pembimbing hanya
        // membuka "Mahasiswa Bimbingan", jadi menu ini dikunci ke aksi tulis.
        label: "Dosen PA",
