...
const gate = (I, a, element) => (
  <PermissionRoute I={I} a={a}>
    {element}
  </PermissionRoute>
);
const gateAny = (any, element) => (
  <PermissionRoute any={any}>{element}</PermissionRoute>
);
...
import { JadwalRuangPage } from "../pages/perkuliahan/JadwalRuangPage";
    ...
    children: [
      {
        ...
        children: [
...

          {
            ...
            element: gate("read", "Fakultas", <FakultasPage />),
          },
          {
            path: "master/departemen",
            element: gate("read", "Departemen", <DepartemenPage />),
          },
          {
            path: "master/prodi/baru",
            element: gate("create", "ProgramStudi", <ProdiFormPage />),
          },
          {
            path: "master/prodi/:id/edit",
            element: gate("update", "ProgramStudi", <ProdiFormPage />),
          },
          {
            path: "master/prodi",
            element: gate("read", "ProgramStudi", <ProdiPage />),
          },
          {
            path: "master/dosen",
          ...
          },
          {
            ...
            element: gate("read", "Matakuliah", <MatakuliahPage />),
          },
          {
            path: "master/gedung",
            element: gate("read", "Gedung", <GedungPage />),
          },
          {
            path: "master/ruang",
            element: gate("read", "Ruang", <RuangPage />),
          },
          {
            path: "master/jenjang-akademik",
            element: gate("read", "JenjangAkademik", <JenjangAkademikPage />),
          },
          {
            path: "master/semester/jenis",
            element: gate("read", "JenisSemester", <JenisSemesterPage />),
          },
          {
            path: "master/semester/setting/baru",
            element: gate("create", "Semester", <SettingSemesterFormPage />),
          },
          {
            path: "master/semester/setting/:id/edit",
            element: gate("update", "Semester", <SettingSemesterFormPage />),
          },
          {
            path: "master/semester/setting",
            element: gate("read", "Semester", <SettingSemesterPage />),
          },
          {
...

          {
            ...
            element: gate("create", "Kurikulum", <KurikulumFormPage />),
          },
          {
            path: "kurikulum/data/:id/edit",
            element: gate("update", "Kurikulum", <KurikulumFormPage />),
          },
          {
            path: "kurikulum/data",
            element: gate("read", "Kurikulum", <KurikulumDataPage />),
          },
          {
            path: "kurikulum/cp",
            element: gate("read", "Cp", <CPKurikulumPage />),
          },
          {
            path: "kurikulum/cpmk/:id/:cpmkId/sub/baru",
            element: gateAny(
              [
                { I: "create", a: "Cpmk" },
                { I: "update", a: "Cpmk" },
          ...
          {
            path: "kurikulum/cpmk/:id/:cpmkId/edit",
            element: gateAny(
              [
                { I: "create", a: "Cpmk" },
                { I: "update", a: "Cpmk" },
          ...
          {
            path: "kurikulum/cpmk",
            element: gate("read", "Cpmk", <CPMKKurikulumPage />),
          },

          {
            ...
            element: gate(
              "read",
              "PenawaranMatakuliah",
              <PenawaranSemesterPage />,
            ),
          },
          {
            path: "perkuliahan/penawaran-mk/:id",
            element: gate(
              "read",
              "PenawaranMatakuliah",
              <PenawaranDetailPage />,
          ...
          },
          {
            ...
            element: <Navigate to="/krs/pengambilan" replace />,
          },
          {
            path: "perkuliahan/persetujuan/krs",
            element: gate("approve", "Krs", <PersetujuanKrsPage />),
          },
          {
            path: "perkuliahan/mk-semester/transkrip/atur",
            element: gate(
              "update",
              "MatakuliahKurikulum",
              <MKTranskripAturPage />,
          ...
          {
            path: "perkuliahan/mk-semester/:id/atur",
            element: gate("update", "Cpmk", <AturCPMKSemesterPage />),
          },
          {
            path: "perkuliahan/mk-semester/:id/evaluasi",
            element: gate("read", "EvaluasiCpmk", <EvaluasiCPMKPage />),
          },
          {
            path: "perkuliahan/mk-semester/:id/dokumen",
            element: gate("read", "DokumenEvaluasi", <DokumenEvaluasiPage />),
          },
          {
            path: "perkuliahan/mk-semester/:id",
            element: gate(
              "read",
              "MatakuliahKurikulum",
              <MKSemesterKelolaPage />,
            ),
          },
          {
            path: "perkuliahan/mk-semester",
            element: gate("read", "MatakuliahKurikulum", <MKSemesterPage />),
          },
          {
            path: "perkuliahan/kelas/:id",
            element: gate("read", "Kelas", <KelasKelolaPage />),
          },
          {
            path: "perkuliahan/kelas",
            element: gate("read", "Kelas", <KelasPage />),
          },
          {
            path: "perkuliahan/jadwal",
            element: gate("read", "JadwalKelas", <JadwalRuangPage />),
          },
          {
            path: "perkuliahan/shift",
            element: gate("read", "Shift", <ShiftPage />),
          },
          {
          ...
          },
          {
            ...
            element: gate("read", "NilaiMahasiswa", <UploadNilaiPage />),
          },
          {
            path: "perkuliahan/rekap-cp",
            element: gate("read", "RekapCp", <RekapCPPage />),
          },
          {
            path: "perkuliahan/laporan-cp/baru",
            element: gate("create", "LaporanCp", <LaporanCPFormPage />),
          },
          {
            path: "perkuliahan/laporan-cp/:id/edit",
            element: gate("update", "LaporanCp", <LaporanCPFormPage />),
          },
          {
            path: "perkuliahan/laporan-cp/:id",
            element: gate("read", "LaporanCp", <LaporanCPViewPage />),
          },
          {
            path: "perkuliahan/laporan-cp",
            element: gate("read", "LaporanCp", <LaporanCPPage />),
          },
          {
            path: "kemahasiswaan/mahasiswa-bimbingan",
            element: gate(
              "read",
              "BimbinganAkademik",
          ...
          },
          {
            ...
            element: gateAny(
              [
                { I: "create", a: "BimbinganAkademik" },
                { I: "update", a: "BimbinganAkademik" },
                { I: "delete", a: "BimbinganAkademik" },
              ],
              <DosenPaPage />,
            ),
          },
          {
            ...
            element: gate("read", "User", <UsersPage />),
          },
          {
            path: "pengaturan/peran",
            element: gate("read", "Role", <RoleMatrixPage />),
          },
          {
            path: "pengaturan/aktivitas",
            element: gate("read", "ActivityLog", <ActivityLogsPage />),
          },
