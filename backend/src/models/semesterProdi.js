...
module.exports = (sequelize) => {
  class SemesterProdi extends Model {
    static associate(models) {
      SemesterProdi.belongsTo(models.ProgramStudi, {
        foreignKey: "program_studi_id",
        as: "programStudi",
      });
      SemesterProdi.belongsTo(models.Semester, {
        foreignKey: "semester_id",
        as: "semester",
      });
      SemesterProdi.hasMany(models.Kelas, {
        foreignKey: "semester_prodi_id",
        as: "kelas",
      });
      SemesterProdi.hasMany(models.Krs, {
        foreignKey: "semester_prodi_id",
        as: "krs",
      });
      SemesterProdi.hasOne(models.PenawaranMatakuliah, {
        foreignKey: "semester_prodi_id",
  ...
  SemesterProdi.init(
    ...
    {
      sequelize,
      modelName: "SemesterProdi",
      tableName: "semester_prodi",
      timestamps: true,
    },
  );
