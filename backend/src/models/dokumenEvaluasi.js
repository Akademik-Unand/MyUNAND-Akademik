...
module.exports = (sequelize) => {
  class DokumenEvaluasi extends Model {
    static associate(models) {
      ...
      DokumenEvaluasi.belongsTo(models.Kelas, {
        foreignKey: "kelas_id",
        as: "kelas",
      });
      DokumenEvaluasi.belongsTo(models.Matakuliah, {
        foreignKey: "matakuliah_id",
        as: "matakuliah",
      });
      DokumenEvaluasi.belongsTo(models.Semester, {
        foreignKey: "semester_id",
        as: "semester",
      });
      DokumenEvaluasi.belongsTo(models.User, {
        foreignKey: "user_id",
        as: "uploader",
      });
    }
