...
module.exports = (sequelize) => {
  class ProgramStudi extends Model {
    static associate(models) {
      ProgramStudi.belongsTo(models.JenjangAkademik, {
        foreignKey: "jenjang_akademik_id",
        as: "jenjangAkademik",
      });
      ProgramStudi.belongsTo(models.ModelKurikulum, {
        foreignKey: "model_kurikulum_id",
        as: "modelKurikulum",
      });
      ProgramStudi.belongsTo(models.Universitas, {
      ...
      ProgramStudi.belongsTo(models.Departemen, {
        foreignKey: "departemen_id",
        as: "departemen",
      });
      ProgramStudi.hasMany(models.Dosen, {
        foreignKey: "program_studi_id",
        as: "dosen",
      });
      ProgramStudi.hasMany(models.Mahasiswa, {
        foreignKey: "program_studi_id",
        as: "mahasiswa",
      });
      ProgramStudi.hasMany(models.Kurikulum, {
        foreignKey: "program_studi_id",
        as: "kurikulum",
      });
      ProgramStudi.hasMany(models.Matakuliah, {
        foreignKey: "program_studi_id",
        as: "matakuliah",
      });
