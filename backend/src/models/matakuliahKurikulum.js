...
module.exports = (sequelize) => {
  class MatakuliahKurikulum extends Model {
    static associate(models) {
      MatakuliahKurikulum.belongsTo(models.Kurikulum, {
        foreignKey: "kurikulum_id",
        as: "kurikulum",
      });
      MatakuliahKurikulum.belongsTo(models.Matakuliah, {
  ...
  MatakuliahKurikulum.init(
    ...
    {
      sequelize,
      modelName: "MatakuliahKurikulum",
      tableName: "matakuliah_kurikulum",
      timestamps: true,
    },
  );
