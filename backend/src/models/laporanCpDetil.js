...
module.exports = (sequelize) => {
  class LaporanCpDetil extends Model {
    static associate(models) {
      LaporanCpDetil.belongsTo(models.LaporanCp, {
        foreignKey: "laporan_cp_id",
        as: "laporan",
      });
      LaporanCpDetil.belongsTo(models.Cpmk, {
        foreignKey: "cpmk_id",
        as: "cpmk",
      });
      LaporanCpDetil.belongsTo(models.Matakuliah, {
        foreignKey: "matakuliah_id",
        as: "matakuliah",
      });
      LaporanCpDetil.belongsTo(models.Semester, {
  ...
  LaporanCpDetil.init(
    ...
    {
      sequelize,
      modelName: "LaporanCpDetil",
      tableName: "laporan_cp_detil",
      timestamps: true,
    },
  );
