...
module.exports = (sequelize) => {
  class Matakuliah extends Model {
    static associate(models) {
      ...
      Matakuliah.belongsTo(models.JenisSemester, {
        foreignKey: "jenis_semester_id",
        as: "jenisSemester",
      });
      Matakuliah.belongsTo(models.TipeMatakuliah, {
        foreignKey: "tipe_matakuliah_id",
        as: "tipeMatakuliah",
      });
      Matakuliah.belongsTo(models.SifatMatakuliah, {
        foreignKey: "sifat_matakuliah_id",
        as: "sifatMatakuliah",
      });
      Matakuliah.hasMany(models.Cpmk, {
        foreignKey: "matakuliah_id",
        as: "cpmk",
      });
      Matakuliah.hasMany(models.Kelas, {
        foreignKey: "matakuliah_id",
        as: "kelas",
      });
      Matakuliah.hasMany(models.PenawaranMatakuliahDetil, {
        foreignKey: "matakuliah_id",
      ...
      Matakuliah.hasMany(models.MatakuliahKurikulum, {
        foreignKey: "matakuliah_id",
        as: "matakuliahKurikulum",
      });
      Matakuliah.hasMany(models.LaporanCpDetil, {
        foreignKey: "matakuliah_id",
        as: "laporanCpDetil",
      });
    }
