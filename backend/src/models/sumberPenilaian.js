...
module.exports = (sequelize) => {
  class SumberPenilaian extends Model {
    static associate(models) {
      SumberPenilaian.belongsTo(models.Cpmk, {
        foreignKey: "cpmk_id",
        as: "cpmk",
      });
      SumberPenilaian.hasMany(models.NilaiMahasiswa, {
        foreignKey: "sumber_penilaian_id",
        as: "nilaiMahasiswa",
      });
    }
  }
  SumberPenilaian.init(
    ...
    {
      sequelize,
      modelName: "SumberPenilaian",
      tableName: "sumber_penilaian",
      timestamps: true,
    },
  );
