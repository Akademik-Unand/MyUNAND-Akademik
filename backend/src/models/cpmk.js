...
module.exports = (sequelize) => {
  class Cpmk extends Model {
    static associate(models) {
      Cpmk.belongsTo(models.Matakuliah, {
        foreignKey: "matakuliah_id",
        as: "matakuliah",
      });
      Cpmk.hasMany(models.SumberPenilaian, {
        foreignKey: "cpmk_id",
        as: "sumberPenilaian",
      });
      ...
      Cpmk.belongsTo(models.Cpmk, {
        foreignKey: "parent_cpmk_id",
        as: "parent",
      });
      Cpmk.hasMany(models.Cpmk, {
        foreignKey: "parent_cpmk_id",
        as: "subCpmk",
      });
      Cpmk.hasMany(models.LaporanCpDetil, {
        foreignKey: "cpmk_id",
        as: "laporanCpDetil",
      });
    }
