...
module.exports = (sequelize) => {
  class LaporanCp extends Model {
    static associate(models) {
      LaporanCp.belongsTo(models.ProgramStudi, {
        foreignKey: "program_studi_id",
        as: "programStudi",
      });
      LaporanCp.belongsTo(models.Kurikulum, {
        foreignKey: "kurikulum_id",
        as: "kurikulum",
      });
      LaporanCp.belongsTo(models.Semester, {
        foreignKey: "semester_id",
        as: "semester",
      });
      LaporanCp.belongsTo(models.User, {
        foreignKey: "dibuat_oleh",
        as: "pembuat",
      });
      LaporanCp.hasMany(models.LaporanCpDetil, {
