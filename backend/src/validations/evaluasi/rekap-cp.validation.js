...
const list = listQuery(["createdAt"], uniqueFields(["mahasiswa_id","cp_id","semester_id"], ORG_FILTER_FIELDS));

const DETAIL_FILTER_FIELDS = uniqueFields(
  ['mahasiswa_id', 'cp_id', 'scp_id', 'semester_id', 'matakuliah_id', 'kelas_id', 'angkatan', 'transkrip_saja', 'pilihan_data'],
  ORG_FILTER_FIELDS
);
