...
router.get(
  ...
  validate({ query: krsValidation.list }),
  krsController.list,
);
...
router.post(
  ...
  validate({ body: krsValidation.create }),
...
router.patch(
  ...
  validate({
    params: krsValidation.detilIdParam,
    body: krsValidation.detilStatus,
  }),
...
router.get(
  ...
  attachAbility,
  checkPermission("read", subject),
  validate({ params: krsValidation.idParam }),
...
router.put(
  ...
  validate({ params: krsValidation.idParam, body: krsValidation.update }),
