...
router.get(
  ...
  validate({ query: usersValidation.list }),
...
router.post(
  ...
  validate({ body: usersValidation.create }),
...
router.put(
  ...
  validate({
    params: usersValidation.idParam,
    body: usersValidation.assignRoles,
  }),
...
router.put(
  ...
  validate({
    params: usersValidation.idParam,
    body: usersValidation.assignUnits,
  }),
...
router.post(
  ...
  validate({ params: usersValidation.idParam }),
...
router.put(
  ...
  validate({ params: usersValidation.idParam, body: usersValidation.update }),
