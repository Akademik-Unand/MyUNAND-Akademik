...
router.get(
  ...
  validate({ query: nilaiValidation.list }),
...
router.post(
  ...
  validate({ body: nilaiValidation.create }),
...
router.get(
  ...
  attachAbility,
  checkPermission("read", subject),
  validate({ params: nilaiValidation.idParam }),
...
router.put(
  ...
  validate({ params: nilaiValidation.idParam, body: nilaiValidation.update }),
