...
const getById = asyncHandler(async (req, res) => {
  ...
  return success(res, {
    message: "Detail Matakuliah Kurikulum berhasil diambil",
    data,
  });
});
...
const create = asyncHandler(async (req, res) => {
  ...
  return success(res, {
    code: 201,
    message: "Matakuliah Kurikulum berhasil ditambahkan",
    data,
  });
});
...
const update = asyncHandler(async (req, res) => {
  ...
  return success(res, {
    message: "Matakuliah Kurikulum berhasil diperbarui",
    data,
  });
});
...
const remove = asyncHandler(async (req, res) => {
  ...
  return success(res, {
    message: "Matakuliah Kurikulum berhasil dihapus",
    data,
  });
});
