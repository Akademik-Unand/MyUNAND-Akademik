...
const getById = asyncHandler(async (req, res) => {
  ...
  return success(res, {
    message: "Detail Jenjang Akademik berhasil diambil",
    data,
  });
});
...
const create = asyncHandler(async (req, res) => {
  ...
  return success(res, {
    code: 201,
    message: "Jenjang Akademik berhasil ditambahkan",
    data,
  });
});
...
const update = asyncHandler(async (req, res) => {
  ...
  return success(res, {
    message: "Jenjang Akademik berhasil diperbarui",
    data,
  });
});
...
const restore = asyncHandler(async (req, res) => {
  ...
  return success(res, {
    message: "Jenjang Akademik berhasil dipulihkan",
    data,
  });
});
