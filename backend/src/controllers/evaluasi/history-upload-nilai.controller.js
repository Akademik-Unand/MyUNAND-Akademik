...
const getById = asyncHandler(async (req, res) => {
  ...
  return success(res, {
    message: "Detail History Upload Nilai berhasil diambil",
    data,
  });
});
...
const create = asyncHandler(async (req, res) => {
  ...
  return success(res, {
    code: 201,
    message: "History Upload Nilai berhasil ditambahkan",
    data,
  });
});
...
const update = asyncHandler(async (req, res) => {
  ...
  return success(res, {
    message: "History Upload Nilai berhasil diperbarui",
    data,
  });
});
...
const remove = asyncHandler(async (req, res) => {
  ...
  return success(res, {
    message: "History Upload Nilai berhasil dihapus",
    data,
  });
});
